...
<html lang="en">
<head>
    <title>Code coverage report for proc.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> proc.js
    </h1>
    <div class='clearfix'>
      ...
      <div class='fl pad1y space-right2'>
        <span class="strong">65.42% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>70/107</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>137/180</span>
      </div>
    </div>
    <p class="quiet">
...
<a name='L750'></a><a href='#L750'>750</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">306646x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">2x</span>
<span class="cline-any cline-yes">2x</span>
<span class="cline-any cline-yes">153520x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
function assignProxy(thisObj, method) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (method.endsWith('Sync'))
<span class="cstat-no" title="statement not covered" >        return new Proxy(thisObj, {</span>
            apply: <span class="fstat-no" title="function not covered" >fu</span>nction (target, thisArg, argArray) {
<span class="cstat-no" title="statement not covered" >                return target[method](...argArray);</span>
            }
        });
    else
...
&nbsp;
    ...
    constructor(api, options = {}) {
        ...
        options.isAsyncDefault = isDefined(options.isAsyncDefault) ? <span class="branch-0 cbranch-no" title="branch not covered" >options.isAsyncDefault </span>: true;
&nbsp;
        return assignProxy(this, (options.isAsyncDefault) ? 'sentences' : <span class="branch-1 cbranch-no" title="branch not covered" >'sentencesSync')</span>;
    }
&nbsp;
    /**
...
&nbsp;
     ...
     */
<span class="fstat-no" title="function not covered" >    st</span>atic async sentences(paragraph) {
        let sent = <span class="cstat-no" title="statement not covered" >[];</span>
<span class="cstat-no" title="statement not covered" >        for (let word of paragraph) {</span>
<span class="cstat-no" title="statement not covered" >            sent.push(word.getReference());</span>
        }
&nbsp;
        let promiseResult = <span class="cstat-no" title="statement not covered" >await JVM.koalaClassOf('proc', 'SentenceSplitter').INSTANCE.sentencesPromise(sent);</span>
<span class="cstat-no" title="statement not covered" >        return JVM.toJsArray(promiseResult, <span class="fstat-no" title="function not covered" >(x</span>) =&gt; <span class="cstat-no" title="statement not covered" >new Sentence(x))</span>;</span>
    }
&nbsp;
    /**
     ...
     * @returns {Sentence} 분리된 문장
     */
<span class="fstat-no" title="function not covered" >    st</span>atic sentencesSync(paragraph) {
        let sent = <span class="cstat-no" title="statement not covered" >[];</span>
<span class="cstat-no" title="statement not covered" >        for (let word of paragraph) {</span>
<span class="cstat-no" title="statement not covered" >            sent.push(word.getReference());</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        return JVM.toJsArray(JVM.koalaClassOf('proc', 'SentenceSplitter').INSTANCE.sentences(sent), <span class="fstat-no" title="function not covered" >(x</span>) =&gt; <span class="cstat-no" title="statement not covered" >new Sentence(x))</span>;</span>
    }
}
&nbsp;
/**
...
&nbsp;
    ...
    constructor(api, options = {}) {
        super();
        <span class="missing-if-branch" title="if path not taken" >I</span>if (api === API.ETRI) {
<span class="cstat-no" title="statement not covered" >            if (options.apiKey) {</span>
<span class="cstat-no" title="statement not covered" >                console.warn(`2.2.0부터 ${this.constructor.name}의 키워드 인자 "apiKey"가 삭제될 예정입니다. 2.1.0부터 추가된 인자인 "etriKey"를 사용해주세요.`);</span>
<span class="cstat-no" title="statement not covered" >                options.etriKey = options.apiKey</span>
            }
            let etriKey = <span class="cstat-no" title="statement not covered" >options.etriKey || '';</span>
<span class="cstat-no" title="statement not covered" >            if (!options.etriKey){</span>
<span class="cstat-no" title="statement not covered" >                console.error(`${this.constructor.name}(API.ETRI)는 키워드 인자 "etriKey"가 필요합니다. ETRI OpenAI hub에서 키를 발급받으세요.`);</span>
<span class="cstat-no" title="statement not covered" >                throw Error('etriKey 값이 비어있음');</span>
            }
<span class="cstat-no" title="statement not covered" >            this._api = API.query(api, this.constructor.name)(etriKey)</span>
        } else <span class="missing-if-branch" title="if path not taken" >I</span>if (api === API.KMR) {
<span class="cstat-no" title="statement not covered" >            if (options.useLightTagger) {</span>
<span class="cstat-no" title="statement not covered" >                console.warn(`2.2.0부터 ${this.constructor.name}의 키워드 인자 "useLightTagger"가 삭제될 예정입니다. 2.1.0부터 추가된 인자인 "kmrLight"를 사용해주세요.`);</span>
<span class="cstat-no" title="statement not covered" >                options.kmrLight = options.useLightTagger</span>
            }
            let useLightTagger = <span class="cstat-no" title="statement not covered" >options.kmrLight || false;</span>
<span class="cstat-no" title="statement not covered" >            this._api = API.query(api, this.constructor.name)(useLightTagger)</span>
            ...
            let rsc = options.khaResource || <span class="branch-1 cbranch-no" title="branch not covered" >'';</span>
            <span class="missing-if-branch" title="if path not taken" >I</span>if (!options.khaResource){
<span class="cstat-no" title="statement not covered" >                console.error(`${this.constructor.name}(API.KHAIII)는 키워드 인자 "khaResource"가 필요합니다. 리소스 파일 위치를 지정해주세요.`);</span>
<span class="cstat-no" title="statement not covered" >                throw Error('khaResource 값이 비어있음');</span>
            }
&nbsp;
...
&nbsp;
        options.isAsyncDefault = isDefined(options.isAsyncDefault) ? <span class="branch-0 cbranch-no" title="branch not covered" >options.isAsyncDefault </span>: true;
        return assignProxy(this, (options.isAsyncDefault) ? 'tag' : <span class="branch-1 cbranch-no" title="branch not covered" >'tagSync')</span>;
    }
&nbsp;
    /**
    ...
    async tag(...text) {
        ...
        for (let paragraph of text) {
            let promiseResult;
            <span class="missing-if-branch" title="if path not taken" >I</span>if (Array.isArray(paragraph)) {
<span class="cstat-no" title="statement not covered" >                promiseResult = await this.tag(...paragraph);</span>
<span class="cstat-no" title="statement not covered" >                result.push(...promiseResult);</span>
            } else {
                if (paragraph.trim().length == 0)
                    continue;
&nbsp;
...
&nbsp;
    ...
    tagSync(...text) {
        ...
        for (let paragraph of text) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (Array.isArray(paragraph)) {
<span class="cstat-no" title="statement not covered" >                result.push(...this.tagSync(...paragraph));</span>
            } else {
                if (paragraph.trim().length == 0)
                    continue;
&nbsp;
    ...
    async tagSentence(...text) {
        ...
        for (let sentence of text) {
            ...
            if (Array.isArray(sentence)) {
                ...
                <span class="missing-if-branch" title="if path not taken" >I</span>if (sentence.trim().length == 0)
...
&nbsp;
     ...
     * @param {boolean} [options.isAsyncDefault=true] 객체를 함수처럼 사용할 때, 즉 processor("문장")과 같이 사용할 때, 기본 호출을 async로 할 지 선택합니다. 기본값은 Asynchronous 호출입니다.
     */
    constructor(api, cls, options = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> {
        super();
&nbsp;
        if (api === API.ETRI) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (options.apiKey) {
<span class="cstat-no" title="statement not covered" >                console.warn(`2.2.0부터 ${this.constructor.name}의 키워드 인자 "apiKey"가 삭제될 예정입니다. 2.1.0부터 추가된 인자인 "etriKey"를 사용해주세요.`);</span>
<span class="cstat-no" title="statement not covered" >                options.etriKey = options.apiKey</span>
            }
            let etriKey = options.etriKey || '';
            <span class="missing-if-branch" title="else path not taken" >E</span>if (!options.etriKey){
...
<span class="cstat-no" title="statement not covered" >            this._api = API.query(api, cls)(etriKey);</span>
        } else {
            this._api = API.query(api, cls)();
        }
&nbsp;
        options.isAsyncDefault = isDefined(options.isAsyncDefault) ? <span class="branch-0 cbranch-no" title="branch not covered" >options.isAsyncDefault </span>: true;
        return assignProxy(this, (options.isAsyncDefault) ? 'analyze' : <span class="branch-1 cbranch-no" title="branch not covered" >'analyzeSync')</span>;
    }
&nbsp;
    /**
...
export class EntityRecognizer extends CanAnalyzeProperty {
     ...
     * @param {boolean} [options.isAsyncDefault=true] 객체를 함수처럼 사용할 때, 즉 processor("문장")과 같이 사용할 때, 기본 호출을 async로 할 지 선택합니다. 기본값은 Asynchronous 호출입니다.
     */
    constructor(api, options = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> {
        super(api, 'EntityRecognizer', options);
<span class="cstat-no" title="statement not covered" >        return assignProxy(this, 'analyze');</span>
    }
}
&nbsp;
/**
...
export class RoleLabeler extends CanAnalyzeProperty {
     ...
     * @param {boolean} [options.isAsyncDefault=true] 객체를 함수처럼 사용할 때, 즉 processor("문장")과 같이 사용할 때, 기본 호출을 async로 할 지 선택합니다. 기본값은 Asynchronous 호출입니다.
     */
<span class="fstat-no" title="function not covered" >    co</span>nstructor(api, options = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> {
<span class="cstat-no" title="statement not covered" >        super(api, 'RoleLabeler', options);</span>
<span class="cstat-no" title="statement not covered" >        return assignProxy(this, 'analyze');</span>
    }
}
&nbsp;
...
&nbsp;
            let tag = pair.tag ? pair.tag.reference : <span class="branch-1 cbranch-no" title="branch not covered" >POS.NNP.reference;</span>
            tagList.push(tag);
        }
&nbsp;
...
&nbsp;
    ...
    contains(word, ...posTags) {
        let tags = (posTags.length &gt; 0) ? posTags : <span class="branch-1 cbranch-no" title="branch not covered" >[POS.NNP, POS.NNG];</span>
        if (tags.length === 1) {
            let tag = tags[0];
...
&nbsp;
     ...
     */
    async importFrom(other, fastAppend = <span class="branch-0 cbranch-no" title="branch not covered" >false,</span> filter = <span class="fstat-no" title="function not covered" ><span class="branch-0 cbranch-no" title="branch not covered" >(x</span>) =&gt; <span class="cstat-no" title="statement not covered" >x.isNoun())</span></span> {
        let tags = [];
        <span class="missing-if-branch" title="else path not taken" >E</span>if (filter instanceof Function) {
            for (let tag of POS.values()) {
                if (filter(tag)) tags.push(tag.tagname);
            }
        } else {
<span class="cstat-no" title="statement not covered" >            for (let tag of filter) {</span>
<span class="cstat-no" title="statement not covered" >                tags.push(tag.tagname);</span>
            }
        }
&nbsp;
...
&nbsp;
     ...
     */
    async getBaseEntries(filter = <span class="fstat-no" title="function not covered" ><span class="branch-0 cbranch-no" title="branch not covered" >(x</span>) =&gt; <span class="cstat-no" title="statement not covered" >x.isNoun())</span></span> {
        let tags = [];
        <span class="missing-if-branch" title="else path not taken" >E</span>if (filter instanceof Function) {
            for (let tag of POS.values()) {
                if (filter(tag)) tags.push(tag.tagname);
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Thu Apr 09 2020 17:00:08 GMT+0900 (GMT+09:00)
</div>
</div>
